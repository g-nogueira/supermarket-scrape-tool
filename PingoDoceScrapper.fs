...
let pageStart = 0
let pageSize = 999999
let supermarketUrl = $"https://mercadao.pt/api/catalogues/6107d28d72939a003ff6bf51/products/search?query=[]&from={pageStart}&size={pageSize}&esPreference=0.6774024649118144"
...
let scrape() =
    let deserialize = Newtonsoft.Json.JsonConvert.DeserializeObject<PingoDoceResponseDTO>
